...
namespace QuanLyBanHang.Forms
{
    public partial class frmHangSanXuat : Form
    {
        ...
        public void BatTatChucNang(bool isEditing)
        {
            ...
            txtTenHangSanXuat.Enabled = isEditing;
        }
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Chưa chọn hãng sản xuất", "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        {
            txtTenHangSanXuat.Text = dataGridView.CurrentRow.Cells["TenHangSanXuat"].Value.ToString();
        }
    ...
    new DataColumn("TenHangSanXuat", typeof(string))
                    ...
                    {
                        var sheet = wb.Worksheets.Add(table, "TenHangSanXuat");
